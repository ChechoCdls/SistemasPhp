...
<body class="nav-md">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha Ingreso" id="fecha_venta" name="fecha_venta" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
  ...
  <script type="text/javascript" src="jsweb/scriptregistrarventa.js"></script>
