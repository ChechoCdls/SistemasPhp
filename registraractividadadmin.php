...
<body class="nav-md">
                  ...
                  <!-- error will be showen here ! -->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="actividad" class="form-control col-md-7 col-xs-12"  name="actividad" placeholder="Nombre de la Actividad" required="true" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="descripcion" class="form-control col-md-7 col-xs-12"  name="descripcion" placeholder="Descripción de la Actividad" type="text" ></textarea>
                      </div>
                    </div>
  ...
  <script type="text/javascript" src="jsweb/scriptregistraract.js"></script>
