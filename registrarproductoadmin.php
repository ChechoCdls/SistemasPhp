...
<head>
  ...
  <title>Comercial Del Mar | Productos </title>
...
<body class="nav-md">
                  ...
                  <!-- error will be showen here ! -->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="nombreproducto" class="form-control col-md-7 col-xs-12"  name="nombreproducto" placeholder="Nombre del Producto" required="true" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="descripcion" class="form-control col-md-7 col-xs-12"  name="descripcion" placeholder="Descripción del Producto" type="text" ></textarea>
                      </div>
                    </div>
  ...
  <script type="text/javascript" src="jsweb/scriptregistrarprod.js"></script>
