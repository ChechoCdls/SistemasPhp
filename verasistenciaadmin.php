            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" action="verasistenciaadmin.php" id="register-form" role="form" method="POST" novalidate>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                ...
                                $sql2 = "SELECT 
                                        ...
                                        OR asistencia.fecha_asistencia BETWEEN '$fecha1' AND '$fecha2'
                                ...
                                foreach($arreglo_asistencia as $asistencia){
                                  ...
                                  $nomape_empleado = $asistencia['nombre_empleado']. ' ' .$asistencia['apellido_empleado'];
                                  ...
                                  echo "<td> <a href='editarasistenciaadmin.php?id=$asistencia[id_empleado]&fecha=$asistencia[fecha_asistencia]' target='_blank' ><button class='btn btn-round btn-warning'> Editar  <span class='glyphicon glyphicon-edit'></span></button></a>
                                    <a href='eliminarasistenciaadmin.php?id=$asistencia[id_empleado]&fecha=$asistencia[fecha_asistencia]' target='_blank' ><button class='btn btn-round btn-danger'> Eliminar  <span class='glyphicon glyphicon-remove'></span></button></a> </td>";
