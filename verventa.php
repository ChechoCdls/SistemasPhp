...
<head>
  ...
  <title>Comercial Del Mar | Ventas </title>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                ...
                                $sql1 = "SELECT
                                        venta.id_venta,
                                        venta.numero_venta,
                                        venta.rutcliente_venta,
                                        venta.nombrecliente_venta,
                                        venta.fecha_venta,
                                        venta.mediopago_venta,
                                        venta.total_venta,
                                        venta.fechapago_venta,
                                        venta.descripcion_venta
                                        FROM venta";

                                $result1 = $db_con->query($sql1) or die(mysql_error());
                                $arreglo_venta = $result1->fetchAll();
                                ...
                                if($numfilas=='0'){
                                  ...
                                  foreach($arreglo_venta as $venta){
                                  $fechaventa = date("d-m-Y", strtotime($venta['fecha_venta']));
                                  $fechapago = date("d-m-Y", strtotime($venta['fechapago_venta']));
                                  echo "<tr>";
                                  echo "<td> $venta[id_venta]</td>";
                                  echo "<td> $venta[numero_venta]</td>";
                                  echo "<td> $venta[rutcliente_venta] </td>";
                                  echo "<td> $venta[nombrecliente_venta] </td>";
                                  echo "<td> $fechaventa</td>";
                                  echo "<td> $venta[mediopago_venta] </td>";
                                  echo "<td> $venta[total_venta] </td>";
                                  echo "<td> $fechapago</td>";
                                  echo "<td> $venta[descripcion_venta] </td>";
