                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                ...
                                $sql1 = "SELECT
                                        ...
                                        compra.rutcliente_compra,
                                        compra.nombrecliente_compra,
                                        compra.fecha_compra,
                                        compra.mediopago_compra,
                                        compra.total_compra,
                                        compra.descripcion_compra
                                        FROM compra";

                                $result1 = $db_con->query($sql1) or die(mysql_error());
                                $arreglo_compra = $result1->fetchAll();
                                ...
                                if($numfilas=='0'){
                                  ...
                                  echo "<td> $compra[numero_compra]</td>";
                                  echo "<td> $compra[rutcliente_compra] </td>";
                                  echo "<td> $compra[nombrecliente_compra] </td>";
                                  echo "<td> $fechacompra</td>";
                                  echo "<td> $compra[mediopago_compra] </td>";
                                  echo "<td> $compra[total_compra] </td>";
                                  echo "<td> $compra[descripcion_compra] </td>";
