                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                ...
                                if($numfilas=='0'){
                                  ...
                                  $fechaproceso = date("d-m-Y", strtotime($trato['fecha_proceso']));
                                  $totalpago = $trato['total_pagar'];
                                  $totalpago2 = number_format($totalpago, 0); 
                                  echo "<tr>";
                                  $idemp = $trato['id_empleado'];
                                  ...
                                  echo "<td> $ $totalpago2 </td>";
                                  echo "<td> $fechaproceso </td>";
                                  echo "<td> $trato[lote_trato] </td>";

                                  echo "<td> <a href='editartratoadmin.php?id=$trato[id_trato]' target='_blank' ><button class='btn btn-round btn-warning'> Editar  <span class='glyphicon glyphicon-edit'></span></button></a>
                                    <a href='eliminartratoadmin.php?id=$trato[id_trato]' target='_blank' ><button class='btn btn-round btn-danger'> Borrar  <span class='glyphicon glyphicon-remove'></span></button></a> </td>";
