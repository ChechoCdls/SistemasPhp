...
<body class="nav-md">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <!-- error will be showen here ! -->
                    ...
                    <span class="section">Empleado: <?php foreach ($arreglo_empleado as $empleado) { ?> <?php echo $empleado['nombre_empleado']. ' ' .$empleado['apellido_empleado']?>  </span>

                    

                    <?php 
                      echo "<input name='id_empleado' id='id_empleado' type='hidden' value=$empleado[id_empleado] />";
                    } ?>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha  *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha " id="fecha_asistencia" name="fecha_asistencia" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="asistencia" id="asistencia" class="form-control col-md-7 col-xs-12"  >
                          <option selected="true" disabled="disabled" >Seleccione Asistencia </option>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="horas" id="horas" >
                          <option  selected="true" disabled="disabled">Seleccione Horas</option>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="horas_extras" class="form-control col-md-7 col-xs-12" value="0"  name="horas_extras" placeholder="Horas Extras" required="required" type="number" min="0" max="100">
                      </div>
                    </div>
  ...
  <!-- -->
  <script type="text/javascript" src="jsweb/scriptregistrarasistencia.js"></script>
