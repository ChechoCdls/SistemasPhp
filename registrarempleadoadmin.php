...
<body class="nav-md">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <!-- error will be showen here ! -->
                    ...
                    <span class="section">Ingrese los datos del nuevo empleado</span>
                  ...
                  <span class="section">Ficha Personal</span>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha Ingreso *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha Ingreso" id="fecha_ingreso" name="fecha_ingreso" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="rut_empleado" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="rut_empleado" placeholder="Rut Empleado" required="required" type="text" onKeyPress="return Rut(event);">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="nombre_empleado" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombre_empleado" placeholder="Nombres" required="required" type="text" onkeyPress="return soloLetras(event);" >
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="apellido_empleado" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="apellido_empleado" placeholder="Apellidos" required="required" type="text" onkeyPress="return soloLetras(event);">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="nacionalidad_empleado" id="nacionalidad_empleado" >
                          <option  value="volvo" selected="true" disabled="disabled">Seleccione Nacionalidad</option>
  ...
  <option value="zimbabwean">Zimbabwean</option>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha Nacimiento * (Separar entre -)</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Formato 01-01-1990" id="nacimiento_empleado" name="nacimiento_empleado" class="form-control col-md-7 col-xs-12" >
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="ciudad_empleado" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="ciudad_empleado" placeholder="Ciudad Nacimiento" type="text" onkeyPress="return soloLetras(event);">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="ecivil_empleado" id="ecivil_empleado" >
                          <option  value="volvo" selected="true" disabled="disabled">Seleccione Estado Civil</option>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" id="email_empleado" name="email_empleado" placeholder="Email" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="telefono_empleado" name="telefono_empleado" placeholder="Teléfono" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="direccion_empleado" class="form-control col-md-7 col-xs-12" name="direccion_empleado" placeholder="Dirección" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="estudios_empleado" class="form-control col-md-7 col-xs-12"  name="estudios_empleado" placeholder="Estudios"  type="text">
                      </div>
                    </div>
                  ...
                  <span class="section">Contrato</span>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="cfamiliar_empleado" class="form-control col-md-7 col-xs-12" value="0"  name="cfamiliar_empleado" placeholder="Cargas Familiares" required="required" type="number" min="0" max="100">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="afp_empleado" id="afp_empleado" >
                          <option value="0" selected="true" disabled="disabled">Seleccione AFP</option>
                          <?php foreach ($arreglo_afp as $afp) { ?>
                          <option value="<?php echo $afp['id_afp'] ?>"><?php echo $afp['nombre_afp'] ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="salud_empleado" id="salud_empleado" >
                          <option value="0" selected="true" disabled="disabled">Seleccione Salud</option>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="cargo_empleado" class="form-control col-md-7 col-xs-12" name="cargo_empleado" placeholder="Cargo" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="area_empleado" class="form-control col-md-7 col-xs-12" name="area_empleado" placeholder="Área" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Inicio de Contrato *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha Inicio" id="fecha_inicio" name="fecha_inicio" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Término de Contrato *</label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha Término" id="fecha_termino" name="fecha_termino" class="form-control col-md-7 col-xs-12" ">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tipo Contrato *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <option selected="true" disabled="disabled">Seleccione Tipo Contrato</option>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Sueldo Base *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="0" type="text" " id="sueldobase" name="sueldobase" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
  ...
  <script type="text/javascript" src="jsweb/scriptregistroempleado.js"></script>
