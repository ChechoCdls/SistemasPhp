...
<body class="nav-md">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" id="register-form" role="form" method="POST" novalidate>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="precio" class="form-control col-md-7 col-xs-12" value="0" name="precio" placeholder="Precio"   type="number">
                      </div>
                    </div>
  ...
  <script type="text/javascript" src="jsweb/scriptasignaract.js"></script>
