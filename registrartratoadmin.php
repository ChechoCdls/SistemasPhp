...
<body class="nav-md">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <!-- error will be showen here ! -->
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha  *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha " id="fecha_trato" name="fecha_trato" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
                    ...
                    <input id="idemp" class="form-control col-md-7 col-xs-12"  name="idemp" placeholder="Valor Kilo" readonly="true"  type="hidden">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="actividad" id="actividad" class="form-control col-md-7 col-xs-12"  >
                          <option selected="true" disabled="disabled" >Seleccione Actividad </option>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="valor_kilo" class="form-control col-md-7 col-xs-12"  name="valor_kilo" placeholder="Valor Kilo" readonly="true"  type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="kilos" class="form-control col-md-7 col-xs-12" name="kilos" placeholder="Cantidad de Kilos" required="required" type="number">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="total_pagar" class="form-control col-md-7 col-xs-12"  name="total_pagar" placeholder="Total a Pagar" readonly="true" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha Proceso  *</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  value="" type="text" placeholder="Fecha Proceso " id="fecha_proceso" name="fecha_proceso" class="form-control col-md-7 col-xs-12" onKeyPress="return SoloNumeros(event);">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="lote" class="form-control col-md-7 col-xs-12" name="lote" placeholder="Lote" required="required" type="text">
                      </div>
                    </div>
  ...
  <script type="text/javascript" src="jsweb/scriptregistrartrato.js"></script>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $("#empleado").change(function(){
        var id = $("#empleado").val();
        var fecha = $("#fecha_trato").val();
        $.post("buscarhora.php", {"empleado":id,"fecha":fecha}, function(data){
        if(data.hora)
        $("#idemp").val(data.hora);
        else
        $("#idemp").val("0");
      ...
      $("#kilos").blur(function(){
          ...
          //jornada hombre
          var jornada = (1/8) *parseFloat(horas);
          //alert (jornada); 

            //emparrillado de jibia $10
            if(($("#actividad").val() =="1") && ($("#producto").val() =="1")){
              var minrendimiento = (270000/30) - (parseFloat(cantkilo)*parseFloat(valorkilo));
              //alert (minrendimiento);
              var valordia = (270000/30) * parseFloat(jornada);
              //alert (valordia);
              var pago = parseFloat(valordia) - parseFloat(minrendimiento);

              if(pago > 0){
                var total = parseFloat(valordia) + parseFloat(pago);
                $("#total_pagar").val(total);
              }else{
                alert("Se le paga sólo el día.");
                $("#total_pagar").val(valordia);
              }   
            }
            //emparrillado de jibia $10
