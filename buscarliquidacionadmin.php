            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" action="buscarliquidacionadmin.php" id="register-form" role="form" method="POST" novalidate>

                    <p class="text-muted font-13 m-b-30">
                    Puede realizar la búsqueda de liquidaciones: Empleado y/o Período.</p>
                    </br></br>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                ...
                                $sql2 = "SELECT 
                                        ...
                                        OR liquidacion.mes = '$mes' AND liquidacion.ano = '$ano'
                                ...
                                foreach($arreglo_liquidacion as $liquidacion){
                                  ...
                                  $totalpago = $liquidacion['sueldoliquido'];
