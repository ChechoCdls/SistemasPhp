                ...
                <div class="x_content">
                  ...
                  <div id="error">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Empleado 
                      </label>
                      ...
                      <span>*Si el usuario será para un empleado, seleccione un empleado de la lista, si no rellene los demás datos*</span>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tipo de Usuario 
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" name="tipousuario" id="tipousuario" >
